...
dataframes = {
    ...
    'WTI_oil_dod': daily[['WTI_oil']].pct_change()*100,
    ...
    'Brent_oil_dod': daily[['Brent_oil']].pct_change()*100,
    ...
    'US_ng_dod': daily[['US_ng']].pct_change()*100,
    ...
    'Hot_rolled_steel_dod': daily[['Hot_rolled_steel']].pct_change()*100,
    ...
    'Baltic_dry_index_dod': daily[['Baltic_dry_index']].pct_change()*100,
    ...
    'Jobless_claims_wow': weekly[['Jobless_claims']].pct_change()*100,
    'Jobless_claims_mom': weekly[['Jobless_claims']].pct_change(4)*100,
    ...
    'CC_borrowing_wow': weekly[['CC_borrowing']].pct_change()*100,
    'CC_borrowing_mom': weekly[['CC_borrowing']].pct_change(4)*100,
    ...
    '30Yr_mortgage_rate_wow': weekly[['30Yr_mortgage_rate']].pct_change()*100,
    '30Yr_mortgage_rate_mom': weekly[['30Yr_mortgage_rate']].pct_change(4)*100,
    ...
    'MBA_mortgage_chng_wow': weekly[['MBA_mortgage_chng']].diff(),
    'MBA_mortgage_chng_mom_diff': weekly[['MBA_mortgage_chng']].diff(4),

    'Diesel_price': weekly[['Diesel']],
    'Diesel_wow': weekly[['Diesel']].pct_change()*100,
    'Diesel_mom': weekly[['Diesel']].pct_change(4)*100,
    ...
    'Crack_spread_wow': weekly[['Crack_spread']].pct_change()*100,
    'Crack_spread_mom': weekly[['Crack_spread']].pct_change(4)*100,
    ...
    'HDPE_wow': weekly[['HDPE']].pct_change()*100,
    'HDPE_mom': weekly[['HDPE']].pct_change(4)*100,
    'HDPE_yoy': weekly_to_month_yoy_pct(weekly[['HDPE']]),
    'HDPE_mom_diff': weekly[['HDPE']].diff(4),

    'PET_price': weekly[['PET']],
    'PET_wow': weekly[['PET']].pct_change()*100,
    'PET_mom': weekly[['PET']].pct_change(4)*100,
    'PET_yoy': weekly_to_month_yoy_pct(weekly[['PET']]),
    'PET_mom_diff': weekly[['PET']].diff(4),

    'Titanium_dioxide_price': weekly[['Titanium_dioxide']],
    'Titanium_dioxide_wow': weekly[['Titanium_dioxide']].pct_change()*100,
    'Titanium_dioxide_mom': weekly[['Titanium_dioxide']].pct_change(4)*100,
    ...
    'Urea_wow': weekly[['Urea']].pct_change()*100,
    'Urea_mom': weekly[['Urea']].pct_change(4)*100,
    'Urea_yoy': weekly_to_month_yoy_pct(weekly[['Urea']]),
    'Urea_mom_diff': weekly[['Urea']].diff(4),

    'Ammonia_price': weekly[['Ammonia']],
    'Ammonia_wow': weekly[['Ammonia']].pct_change()*100,
    'Ammonia_mom': weekly[['Ammonia']].pct_change(4)*100,
    ...
    'Container_shipping_wow': weekly[['Container_shipping']].pct_change()*100,
    'Container_shipping_mom': weekly[['Container_shipping']].pct_change(4)*100,
    ...
    'Retail_sales_total_mom': monthly[['Retail_sales_total']].pct_change()*100,
    'Retail_sales_total_yoy': monthly[['Retail_sales_total']].pct_change(12)*100,
    ...
    'Retail_sales_ex_auto_gas_mom': monthly[['Retail_sales_ex_auto_gas']].pct_change()*100,
    'Retail_sales_ex_auto_gas_yoy': monthly[['Retail_sales_ex_auto_gas']].pct_change(12)*100,
    'Retail_sales_ex_auto_gas_mom_diff': monthly[['Retail_sales_ex_auto_gas']].diff(),

    'CPI_total_price': monthly[['CPI_total']],
    'CPI_total_mom': monthly[['CPI_total']].pct_change()*100,
    'CPI_total_yoy': monthly[['CPI_total']].pct_change(12)*100,
    'CPI_total_mom_diff': monthly[['CPI_total']].diff(),

    'CPI_less_food_gas_price': monthly[['CPI_less_food_gas']],
    'CPI_less_food_gas_mom': monthly[['CPI_less_food_gas']].pct_change()*100,
    'CPI_less_food_gas_yoy': monthly[['CPI_less_food_gas']].pct_change(12)*100,
    'CPI_less_food_gas_mom_diff': monthly[['CPI_less_food_gas']].diff(),

    'CPI_food_bev_price': monthly[['CPI_food_bev']],
    'CPI_food_bev_mom': monthly[['CPI_food_bev']].pct_change()*100,
    'CPI_food_bev_yoy': monthly[['CPI_food_bev']].pct_change(12)*100,
    'CPI_food_bev_mom_diff': monthly[['CPI_food_bev']].diff(),

    'CPI_housing_price': monthly[['CPI_housing']],
    'CPI_housing_mom': monthly[['CPI_housing']].pct_change()*100,
    'CPI_housing_yoy': monthly[['CPI_housing']].pct_change(12)*100,
    'CPI_housing_mom_diff': monthly[['CPI_housing']].diff(),

    'CPI_apparel_price': monthly[['CPI_apparel']],
    'CPI_apparel_mom': monthly[['CPI_apparel']].pct_change()*100,
    'CPI_apparel_yoy': monthly[['CPI_apparel']].pct_change(12)*100,
    'CPI_apparel_mom_diff': monthly[['CPI_apparel']].diff(),

    'CPI_transportation_price': monthly[['CPI_transportation']],
    'CPI_transportation_mom': monthly[['CPI_transportation']].pct_change()*100,
    'CPI_transportation_yoy': monthly[['CPI_transportation']].pct_change(12)*100,
    'CPI_transportation_mom_diff': monthly[['CPI_transportation']].diff(),

    'CPI_medical_price': monthly[['CPI_medical']],
    'CPI_medical_mom': monthly[['CPI_medical']].pct_change()*100,
    'CPI_medical_yoy': monthly[['CPI_medical']].pct_change(12)*100,
    'CPI_medical_mom_diff': monthly[['CPI_medical']].diff(),

    'CPI_rec_price': monthly[['CPI_rec']],
    'CPI_rec_mom': monthly[['CPI_rec']].pct_change()*100,
    'CPI_rec_yoy': monthly[['CPI_rec']].pct_change(12)*100,
    'CPI_rec_mom_diff': monthly[['CPI_rec']].diff(),

    'CPI_edu_price': monthly[['CPI_edu']],
    'CPI_edu_mom': monthly[['CPI_edu']].pct_change()*100,
    'CPI_edu_yoy': monthly[['CPI_edu']].pct_change(12)*100,
    'CPI_edu_mom_diff': monthly[['CPI_edu']].diff(),

    'CPI_other_price': monthly[['CPI_other']],
    'CPI_other_mom': monthly[['CPI_other']].pct_change()*100,
    'CPI_other_yoy': monthly[['CPI_other']].pct_change(12)*100,
    'CPI_other_mom_diff': monthly[['CPI_other']].diff(),

    'Non_farm_payroll_price': monthly[['Non_farm_payroll']],
    'Non_farm_payroll_mom': monthly[['Non_farm_payroll']].pct_change()*100,
    'Non_farm_payroll_yoy': monthly[['Non_farm_payroll']].pct_change(12)*100,
    'Non_farm_payroll_mom_diff': monthly[['Non_farm_payroll']].diff(),

    'Avg_hourly_earnings_price': monthly[['Avg_hourly_earnings']],
    'Avg_hourly_earnings_mom': monthly[['Avg_hourly_earnings']].pct_change()*100,
    'Avg_hourly_earnings_yoy': monthly[['Avg_hourly_earnings']].pct_change(12)*100,
    'Avg_hourly_earnings_mom_diff': monthly[['Avg_hourly_earnings']].diff(),

    'UMich_sentiment_price': monthly[['UMich_sentiment']],
    'UMich_sentiment_mom': monthly[['UMich_sentiment']].pct_change()*100,
    'UMich_sentiment_yoy': monthly[['UMich_sentiment']].pct_change(12)*100,
    'UMich_sentiment_mom_diff': monthly[['UMich_sentiment']].diff(),

    'Housing_permits_price': monthly[['Housing_permits']],
    'Housing_permits_mom': monthly[['Housing_permits']].pct_change()*100,
    'Housing_permits_yoy': monthly[['Housing_permits']].pct_change(12)*100,
    'Housing_permits_mom_diff': monthly[['Housing_permits']].diff(),

    'Housing_starts_price': monthly[['Housing_starts']],
    'Housing_starts_mom': monthly[['Housing_starts']].pct_change()*100,
    'Housing_starts_yoy': monthly[['Housing_starts']].pct_change(12)*100,
    'Housing_starts_mom_diff': monthly[['Housing_starts']].diff(),

    'Existing_home_sales_price': monthly[['Existing_home_sales']],
    'Existing_home_sales_mom': monthly[['Existing_home_sales']].pct_change()*100,
    'Existing_home_sales_yoy': monthly[['Existing_home_sales']].pct_change(12)*100,
    'Existing_home_sales_mom_diff': monthly[['Existing_home_sales']].diff(),

    'New_home_sales_price': monthly[['New_home_sales']],
    'New_home_sales_mom': monthly[['New_home_sales']].pct_change()*100,
    'New_home_sales_yoy': monthly[['New_home_sales']].pct_change(12)*100,
    'New_home_sales_mom_diff': monthly[['New_home_sales']].diff(),

    'Construction_spending_price': monthly[['Construction_spending']],
    'Construction_spending_mom': monthly[['Construction_spending']].pct_change()*100,
    'Construction_spending_yoy': monthly[['Construction_spending']].pct_change(12)*100,
    'Construction_spending_mom_diff': monthly[['Construction_spending']].diff(),

    'Job_openings_price': monthly[['Job_openings']],
    'Job_openings_mom': monthly[['Job_openings']].pct_change()*100,
    'Job_openings_yoy': monthly[['Job_openings']].pct_change(12)*100,
    'Job_openings_mom_diff': monthly[['Job_openings']].diff(),

    'Hires_price': monthly[['Hires']],
    'Hires_mom': monthly[['Hires']].pct_change()*100,
    'Hires_yoy': monthly[['Hires']].pct_change(12)*100,
    'Hires_mom_diff': monthly[['Hires']].diff(),

    'Separations_price': monthly[['Separations']],
    'Separations_mom': monthly[['Separations']].pct_change()*100,
    'Separations_yoy': monthly[['Separations']].pct_change(12)*100,
    'Separations_mom_diff': monthly[['Separations']].diff(),

    'JOLTS_price': monthly[['JOLTS']],
    'JOLTS_mom': monthly[['JOLTS']].pct_change()*100,
    'JOLTS_yoy': monthly[['JOLTS']].pct_change(12)*100,
    'JOLTS_mom_diff': monthly[['JOLTS']].diff(),

    'EU_ng_price': monthly[['EU_ng']],
    'EU_ng_mom': monthly[['EU_ng']].pct_change()*100,
    'EU_ng_yoy': monthly[['EU_ng']].pct_change(12)*100,
    'EU_ng_mom_diff': monthly[['EU_ng']].diff(),

    'Copper_price': monthly[['Copper']],
    'Copper_mom': monthly[['Copper']].pct_change()*100,
    'Copper_yoy': monthly[['Copper']].pct_change(12)*100,
    'Copper_mom_diff': monthly[['Copper']].diff(),

    'Aluminum_price': monthly[['Aluminum']],
    'Aluminum_mom': monthly[['Aluminum']].pct_change()*100,
    'Aluminum_yoy': monthly[['Aluminum']].pct_change(12)*100,
    'Aluminum_mom_diff': monthly[['Aluminum']].diff(),

    'Iron_ore_price': monthly[['Iron_ore']],
    'Iron_ore_mom': monthly[['Iron_ore']].pct_change()*100,
    'Iron_ore_yoy': monthly[['Iron_ore']].pct_change(12)*100,
    'Iron_ore_mom_diff': monthly[['Iron_ore']].diff(),

    'Lumber_price': monthly[['Lumber']],
    'Lumber_mom': monthly[['Lumber']].pct_change()*100,
    'Lumber_yoy': monthly[['Lumber']].pct_change(12)*100,
    'Lumber_mom_diff': monthly[['Lumber']].diff(),

    'Asphalt_price': monthly[['Asphalt']],
    'Asphalt_mom': monthly[['Asphalt']].pct_change()*100,
    'Asphalt_yoy': monthly[['Asphalt']].pct_change(12)*100,
    'Asphalt_mom_diff': monthly[['Asphalt']].diff(),

    'Nitrogen_fertilizer_price': monthly[['Nitrogen_fertilizer']],
    'Nitrogen_fertilizer_mom': monthly[['Nitrogen_fertilizer']].pct_change()*100,
    'Nitrogen_fertilizer_yoy': monthly[['Nitrogen_fertilizer']].pct_change(12)*100,
    'Nitrogen_fertilizer_mom_diff': monthly[['Nitrogen_fertilizer']].diff(),

    'Wheat_price': monthly[['Wheat']],
    'Wheat_mom': monthly[['Wheat']].pct_change()*100,
    'Wheat_yoy': monthly[['Wheat']].pct_change(12)*100,
    'Wheat_mom_diff': monthly[['Wheat']].diff(),

    'Pork_price': monthly[['Pork']],
    'Pork_mom': monthly[['Pork']].pct_change()*100,
    'Pork_yoy': monthly[['Pork']].pct_change(12)*100,
    'Pork_mom_diff': monthly[['Pork']].diff(),

    'Beef_price': monthly[['Beef']],
    'Beef_mom': monthly[['Beef']].pct_change()*100,
    'Beef_yoy': monthly[['Beef']].pct_change(12)*100,
    'Beef_mom_diff': monthly[['Beef']].diff(),

    'Chicken_price': monthly[['Chicken']],
    'Chicken_mom': monthly[['Chicken']].pct_change()*100,
    'Chicken_yoy': monthly[['Chicken']].pct_change(12)*100,
    'Chicken_mom_diff': monthly[['Chicken']].diff(),

    'Cooking_oil_price': monthly[['Cooking_oil']],
    'Cooking_oil_mom': monthly[['Cooking_oil']].pct_change()*100,
    'Cooking_oil_yoy': monthly[['Cooking_oil']].pct_change(12),
    'Cooking_oil_mom_diff': monthly[['Cooking_oil']].diff(),

    'Flour_price': monthly[['Flour']],
    'Flour_mom': monthly[['Flour']].pct_change()*100,
    'Flour_yoy': monthly[['Flour']].pct_change(12)*100,
    'Flour_mom_diff': monthly[['Flour']].diff(),

    'ISM_mfg_price': monthly[['ISM_mfg']],
    'ISM_mfg_mom': monthly[['ISM_mfg']].pct_change()*100,
    'ISM_mfg_yoy': monthly[['ISM_mfg']].pct_change(12)*100,
    'ISM_mfg_mom_diff': monthly[['ISM_mfg']].diff(),

    'PMI_price': monthly[['PMI']],
    'PMI_mom': monthly[['PMI']].pct_change()*100,
    'PMI_yoy': monthly[['PMI']].pct_change(12)*100,
    'PMI_mom_diff': monthly[['PMI']].diff(),

    'Trucking_conditions_price': monthly[['Trucking_conditions']],
    'Trucking_conditions_mom': monthly[['Trucking_conditions']].pct_change()*100,
    'Trucking_conditions_yoy': monthly[['Trucking_conditions']].pct_change(12)*100,
...
transformation_options = {
    ...
    'Baltic_dry_index': [
        {'label': 'Index', 'value': 'Baltic_dry_index_price'},
    ...
    'Jobless_claims': [
        {'label': 'Level', 'value': 'Jobless_claims_price'},
    ...
    'CC_borrowing': [
        {'label': 'Level', 'value': 'CC_borrowing_price'},
    ...
    '30Yr_mortgage_rate': [
        {'label': 'Rate', 'value': '30Yr_mortgage_rate_price'},
    ...
    'MBA_mortgage_chng': [
        {'label': 'Change', 'value': 'MBA_mortgage_chng_price'},
        {'label': 'WoW Diff', 'value': 'MBA_mortgage_chng_wow'},
    ...
    'Crack_spread': [
        {'label': 'Spread', 'value': 'Crack_spread_price'},
    ...
    'Container_shippings': [
        {'label': 'Rate', 'value': 'Container_shipping_price'},
    ...
    'Retail_sales_total': [
        {'label': 'Level', 'value': 'Retail_sales_total_price'},
    ...
    'Retail_sales_ex_auto_gas': [
        {'label': 'Level', 'value': 'Retail_sales_ex_auto_gas_price'},
    ...
    'CPI_total': [
        {'label': 'Index', 'value': 'CPI_total_price'},
    ...
    'CPI_less_food_gas': [
        {'label': 'Index', 'value': 'CPI_less_food_gas_price'},
    ...
    'CPI_food_bev': [
        {'label': 'Index', 'value': 'CPI_food_bev_price'},
    ...
    'CPI_housing': [
        {'label': 'Index', 'value': 'CPI_housing_price'},
    ...
    'CPI_apparel': [
        {'label': 'Index', 'value': 'CPI_apparel_price'},
    ...
    'CPI_transportation': [
        {'label': 'Index', 'value': 'CPI_transportation_price'},
    ...
    'CPI_medical': [
        {'label': 'Index', 'value': 'CPI_medical_price'},
    ...
    'CPI_rec': [
        {'label': 'Index', 'value': 'CPI_rec_price'},
    ...
    'CPI_edu': [
        {'label': 'Index', 'value': 'CPI_edu_price'},
    ...
    'CPI_other': [
        {'label': 'Index', 'value': 'CPI_other_price'},
    ...
    'Non_farm_payroll': [
        {'label': 'Level', 'value': 'Non_farm_payroll_price'},
    ...
    'Avg_hourly_earnings': [
        {'label': 'Level', 'value': 'Avg_hourly_earnings_price'},
    ...
    'UMich_sentiment': [
        {'label': 'Index', 'value': 'UMich_sentiment_price'},
    ...
    'Housing_permits': [
        {'label': 'Level', 'value': 'Housing_permits_price'},
    ...
    'Housing_starts': [
        {'label': 'Level', 'value': 'Housing_starts_price'},
    ...
    'Existing_home_sales': [
        {'label': 'Level', 'value': 'Existing_home_sales_price'},
    ...
    'New_home_sales': [
        {'label': 'Level', 'value': 'New_home_sales_price'},
    ...
    'Construction_spending': [
        {'label': 'Level', 'value': 'Construction_spending_price'},
    ...
    'Job_openings': [
        {'label': 'Level', 'value': 'Job_openings_price'},
    ...
    'Separations': [
        {'label': 'Level', 'value': 'Separations_price'},
    ...
    'Lumber': [
        {'label': 'Index', 'value': 'Lumber_price'},
    ...
    'Asphalt': [
        {'label': 'Index', 'value': 'Asphalt_price'},
    ...
    'Nitrogen_fertilizer': [
        {'label': 'Index', 'value': 'Nitrogen_fertilizer_price'},
    ...
    'ISM_mfg': [
        {'label': 'Index', 'value': 'ISM_mfg_price'},
    ...
    'Trucking_conditions': [
        {'label': 'Index', 'value': 'Trucking_conditions_price'},
